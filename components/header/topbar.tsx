...
export function Topbar() {
  ...
  return (
   <>
      {/* Desktop */}
      <div className="bg-[#1B2564] text-[#ffffff] hidden lg:block">
         <div className="mx-auto px-6 xl:px-12 py-2 flex items-center justify-between text-sm">
            <div className="flex items-center gap-6">
            <Link href="#" className="hover:underline">Help Center</Link>
            <Link href="#" className="How it Works">How it Works</Link>
            <Link href="#" className="hover:underline">Become a Retailer</Link>
            </div>
            <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
               <span>🎉</span>
               <span>Free delivery on orders over 500Rs!</span>
            </div>
            <DropdownMenu>
               ...
               <DropdownMenuContent>
                  <DropdownMenuItem>Mauritius Island (MUR Rs)</DropdownMenuItem>
                  <DropdownMenuItem>USA (Dollar)</DropdownMenuItem>
                  <DropdownMenuItem>Canada (Dollar)</DropdownMenuItem>
                  <DropdownMenuItem>UK (Euro)</DropdownMenuItem>
               </DropdownMenuContent>
            </DropdownMenu>
            <div className="flex items-center gap-3">
               ...
               <Link href="#" className="hover:opacity-80" aria-label="X">
      ...
      {/* Mobile */}
      <div className="bg-[#1B2564] text-[#ffffff] lg:hidden">
